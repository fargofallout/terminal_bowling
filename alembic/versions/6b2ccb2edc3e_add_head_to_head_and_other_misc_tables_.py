...
def upgrade() -> None:
    ...
    op.create_table("bowler_head_to_head_game_table",
        ...
        sa.Column("left_bowler_scratch_score", sa.Integer),
        sa.Column("left_bowler_handicap_score", sa.Integer),
        sa.Column("right_bowler_scratch_score", sa.Integer),
        sa.Column("right_bowler_handicap_score", sa.Integer),
